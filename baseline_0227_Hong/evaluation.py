...
def evaluation(gt_dir, pred_dir):
    ...
    gt = pd.read_csv(os.path.join(gt_dir, 'info.csv')) # 'gt.csv'))
...
if __name__ == '__main__':
   gt_dir ='/opt/ml/input/data/eval' # os.environ.get('SM_GROUND_TRUTH_DIR')
   pred_dir ='/opt/ml/code/baseline_0225/output' #os.environ.get('SM_OUTPUT_DATA_DIR')
